      ...
      {showDeleteConfirm && (
        <div className="modal-overlay" onClick={() => setShowDeleteConfirm(false)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            <p className="modal-title">deletar conta</p>
            <p className="modal-body">
              Isso vai apagar sua conta e todo o histórico de análises permanentemente. Essa ação não pode ser desfeita.
            </p>
      ...
      <style jsx global>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .modal-title {
          ...
          color: #ff8080; letter-spacing: 0.02em;
        }

        .modal-body {
          font-family: var(--font-sans); font-size: 0.85rem;
          color: var(--text-muted); line-height: 1.65; font-weight: 300;
        }
        ...
        .spinner {
          ...
          border-top-color: #0e0e0f; border-radius: 50%;
